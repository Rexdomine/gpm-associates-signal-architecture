      ...
      <main id="main-content">
        ...
        <section className="services-integrated" aria-labelledby="services-integrated-title">
          <div className="shell services-integrated-grid">
            <figure data-reveal>
              <Image src="/images/gpm-services-integrated-grounded-brainstorming-nigeria-2026.webp" alt="Three Nigerian professionals—including a woman in a hijab and a man in native attire with a northern cap—brainstorming around laptops, notebooks and a paper data-flow sketch" width={1536} height={1024} sizes="(max-width: 800px) 100vw, 55vw" />
